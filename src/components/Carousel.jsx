      ...
      <div className="w-full">
        ...
        >
          <div className="h-full w-full bg-gradient-to-r from-black flex flex-col items-start px-6 pt-32 md:px-32">
            ...
            <Link
              to="/products"
              className="text-base active:scale-90 active:opacity-70 md:text-base mt-10 text-white border border-white font-semibold py-2 px-4 md:py-3 md:px-6 rounded md:rounded-lg hover:bg-white hover:text-black transition-all duration-300"
            >
              Jetzt bestellen
            </Link>
          </div>
